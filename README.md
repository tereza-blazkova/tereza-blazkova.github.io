...
<body>
    ...
    <div class="container">
        ...
        <section id="publications">
            <h2>Publications</h2>
            <ul>
                <li>Tereza Blazkova, Esben Rahbek Gjerdrum Pedersen, Kirsti Reitan Andersen, Francesco Rosati - <a href="https://www.sciencedirect.com/science/article/pii/S0959652623034182">Greenwashing debates on Twitter: Stakeholders and critical topics</a></li>
        ...
        <section id="blog">
            <h2>Blog</h2>
            <ul>
                <li><a href="my-motivation.html">My motivation to have a personal website</a> - A brief overview of why I created this website and what I hope to achieve with it.</li>
            </ul>
        </section>
        <section id="contact">
            <h2>Contact</h2>
            <ul>
                <li>Email: <a href="mailto:tebla@sodas.ku.dk">tebla@sodas.ku.dk</a></li>
                <li>LinkedIn: <a href="https://www.linkedin.com/in/tblazkova/">linkedin.com/in/tblazkova/</a></li>
                <li>Google Scholar: <a href="https://scholar.google.com/citations?user=BPCG6uoAAAAJ&hl=cs">Google Scholar profile</a></li>
                <li>X: <a href="https://twitter.com/tereza_blazek">@tereza_blazek</a></li>
            </ul>
        </section>
        <section id="cv">
            <h2>CV</h2>
            <p>You can view or download my CV using the links below:</p>
            <a href="cv.pdf" target="_blank">View CV (PDF)</a>
            <br>
            <a href="cv.pdf" download>Download CV (PDF)</a>
        </section>
    </div>
    <footer>
        <p>© 2024 Tereza Blažková. All rights reserved.</p>
    </footer>
</body>
</html>
